...
interface IERC1820Registry {
    ...
    event InterfaceImplementerSet(address indexed account, bytes32 indexed interfaceHash, address indexed 
...
contract ERC777 is Context, IERC777, IERC20 {
    ...
    IERC1820Registry constant internal _ERC1820_REGISTRY = IERC1820Registry
...
override {
    ...
    */
    function transferFrom(address holder, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(holder, spender, _allowances[holder][spender].sub(amount, "ERC777: transfer amount exceeds 
